...
<body class="flex flex-col items-center ">
    ...
    <div>
        <div class="w-full flex justify-center items-center space-x-4 mb-4 sm:hidden px-4">
            ...
            <div id="map" class="w-full h-64 mt-20 md:h-96 hidden sm:block"></div>
    </div>
    ...
    <div class="filters bg-white mt-4 w-full hidden md:w-3/4 p-4 rounded-lg shadow-md sm:block md:block 2xl:hidden">
    ...
    <div class="flex flex-col w-full sm:flex-row sm:justify-start sm:w-full md:w-3/4 mt-8">
        <!-- Результаты поиска -->
            ...
            <!-- Кнопки для переключения отображения -->
        ...
        <div id="listView" class="w-full">
            ...
            @if($adverts->count())
                ...
                <div class="hidden 
                sm:flex w-full flex-col items-start justify-center 
                md:flex w-full flex-col items-start justify-center w-full
        ...
        <div class="filters bg-white mt-4 ml-auto hidden 2xl:block">
            ...
            <form method="GET" class=" p-2 rounded-lg shadow-md " action="{{ route('adverts.search') }}">
